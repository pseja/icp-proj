...
QString CodeGenerator::generateMainFunction(FSM* fsm) {
  ...
  code += "                log(SECTION_SEPARATOR);\n";
  code += "                log(ANSI_BOLD + COLOR_HEADER + \"CLIENT CONNECTION:\" + ANSI_RESET);\n";
  code += "                if (clientSocket && clientSocket->state() == QAbstractSocket::ConnectedState) {\n";
  code += "                    log(\"  \" + COLOR_SUCCESS + \"Client connected\" + ANSI_RESET + \" (\" + clientSocket->peerAddress().toString() + \")\");\n";
  code += "                } else {\n";
  code += "                    log(\"  \" + COLOR_WARNING + \"No client connected\" + ANSI_RESET);\n";
  code += "                }\n";
  code += "                // Show inputs\n";
  code += "                log(SECTION_SEPARATOR);\n";
  ...
  code += "            debug(\"TCP: Extra client attempted to connect from \" + extra->peerAddress().toString() + \":\" + QString::number(extra->peerPort()));\n";
  ...
  code += "        debug(\"TCP: Client connected from \" + clientSocket->peerAddress().toString() + \":\" + QString::number(clientSocket->peerPort()));\n\n";
  ...
  code += "                        debug(\"TCP: Input '\" + name + \"' set to '\" + value + \"'\");\n";
  code += "                    } else {\n";
  ...
  code += "                        debug(\"TCP: Input '\" + name + \"' called\");\n";
  code += "                    } else {\n";
  ...
  code += "                    clientSocket->write(buildEvent(disconnectMsg));\n";
  code += "                    clientSocket->flush();\n";
